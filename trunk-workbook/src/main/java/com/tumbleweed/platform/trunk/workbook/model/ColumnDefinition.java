package com.tumbleweed.platform.trunk.workbook.model;
...
public class ColumnDefinition<T> implements FormulaCell, Serializable {
    ...
    public ColumnDefinition(String name, String fieldNameOfValue, String fieldTypeOfValue, boolean hidden) {
        this.name = name;
        this.fieldNameOfValue = fieldNameOfValue;
        this.fieldTypeOfValue = fieldTypeOfValue;
        this.hidden = hidden;
    ...
    public ColumnDefinition(String name, String fieldNameOfValue, String fieldTypeOfValue, boolean editable,
            String formula) {
        this.name = name;
        this.fieldNameOfValue = fieldNameOfValue;
        this.fieldTypeOfValue = fieldTypeOfValue;
